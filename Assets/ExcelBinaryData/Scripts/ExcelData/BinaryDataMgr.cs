...
public class BinaryDataMgr
{
	...
	public void LoadTable<T,K>()
	{
		...
		using (FileStream fs = File.Open(DATA_BINARY_PATH + typeof(K).Name + ".bininfo", FileMode.Open, FileAccess.Read))
		{
	...
	public void Save(object obj, string fileName)
	{
		...
		using (FileStream fs = new FileStream(SAVE_PATH + fileName + ".bininfo", FileMode.OpenOrCreate, FileAccess.Write))
		{
	...
	public T Load<T>(string fileName) where T:class
	{
		...
		if( !File.Exists(SAVE_PATH + fileName + ".bininfo") )
			return default(T);

		T obj;
		using (FileStream fs = File.Open(SAVE_PATH + fileName + ".bininfo", FileMode.Open, FileAccess.Read))
		{
			BinaryFormatter bf = new BinaryFormatter();
